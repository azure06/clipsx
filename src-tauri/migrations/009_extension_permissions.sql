-- Extension grants are deliberately tied to immutable package bytes.
...
CREATE TABLE extension_permission_grants (
    ...
    permission_kind TEXT NOT NULL CHECK (permission_kind IN ('external_navigation', 'http', 'provider', 'background_clip_created', 'source_application')),
