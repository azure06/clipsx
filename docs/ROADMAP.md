...
- Keep raw filesystem, clipboard, history, database, shell, environment, credential values, provider handles, and frontend-code access unavailable to extensions.
