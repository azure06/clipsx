...
```powershell
cargo build --release --target wasm32-unknown-unknown --manifest-path examples/extensions/ask-ai/Cargo.toml
Copy-Item examples/extensions/ask-ai/target/wasm32-unknown-unknown/release/clipsx_ask_ai.wasm examples/extensions/ask-ai/component.wasm
