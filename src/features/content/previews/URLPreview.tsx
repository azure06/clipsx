        ...
        <div className="relative flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5 mb-1">
              ...
              <span className="text-xs text-blue-300 font-semibold uppercase tracking-wider">{domain}</span>
            </div>
            <p className="text-base font-medium text-white/90 break-all leading-relaxed">
              {url}
            </p>
          </div>
