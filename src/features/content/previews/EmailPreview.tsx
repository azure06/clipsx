...
const EmailPreviewComponent = ({ content }: EmailPreviewProps) => {
  ...
  return (
    <div className="flex flex-col gap-4 p-4">
      ...
      <div
        onClick={handleSend}
        className="group relative p-4 rounded-xl bg-linear-to-br from-amber-500/10 to-orange-500/10 border border-amber-500/20 hover:border-amber-400/40 cursor-pointer transition-all duration-300 hover:shadow-[0_0_20px_rgba(251,191,36,0.15)] overflow-hidden"
      >
        <div className="absolute inset-0 bg-linear-to-r from-transparent via-amber-500/5 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000" />
