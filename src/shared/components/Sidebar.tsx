    ...
    <div className="flex w-12 shrink-0 flex-col items-center py-3">
      ...
      <div className="flex flex-col items-center gap-1">
        ...
        >
          ...
          {activeView === 'clips' && (
            <div className="absolute left-0 top-1/2 h-5 w-0.5 -translate-y-1/2 rounded-r bg-blue-500 dark:bg-gray-400" />
          )}
        </button>
      ...
      <div className="flex flex-col items-center gap-1">
        <button
          ...
          className="flex h-8 w-8 items-center justify-center rounded-lg text-gray-500 transition-colors cursor-pointer hover:bg-gray-200/50 dark:hover:bg-gray-800/50 hover:text-gray-700 dark:hover:text-gray-300"
          title="Account"
        >
